...
namespace Open.Tests.Archetypes.RuleClasses {
    [TestClass] public class BooleanVariableTests : CommonTests<BooleanVariable> {
        protected override BooleanVariable GetRandomObj() { return BooleanVariable.Random(); }
        ...
        [TestMethod] public void EmptyTest() { TestSingleton(() => BooleanVariable.Empty); }
    }
}
